...
import { ChevronLeft, ChevronRight, Package, Plus, Search } from 'lucide-react-native';
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'flex-start', gap: 10 }}>
          ...
          <View style={{ flex: 1, minWidth: 0 }}>
            ...
            <Text style={styles.subtitle}>
              Última compra: {formatFecha(household?.ultima_fecha_compra ?? null)} · {pending} pendientes de {total}
            </Text>
          </View>
      ...
      <Button
        variant="primary"
        style={styles.fab}
        onPress={() => sheetRef.current?.presentForCreate()}
      >
